...
function resetGame() {
  ...
  this.score_p1 = 0,
    ...
    buttonMH.style.backgroundColor = "white"
...
function addSelection(ind) {
  ...
  if (game.currentPlayer === 'm') {
    ...
    if (!this.handleSelection(Math.floor(ind / 3), ind % 3)) {
...
function humanVshuman() {
  ...
  game.updateScore()
  buttonHH.style.backgroundColor = "gray"
...
function machineVshuman() {
  ...
  buttonMH.style.backgroundColor = "gray"
  buttonMH.style.color = "white"
}

/* handle selection Human vs Human */
